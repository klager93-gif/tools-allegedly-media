# Saved Schedules Foundation — v4.6.0

Signal Schedule v4.6.0 adds the first protected database-backed save/load foundation for schedule drafts and published schedule payloads.
