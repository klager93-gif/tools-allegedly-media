## Signal Schedule v4.5.0 — Saved Schedule CRUD + True Release Rebuild

Adds protected saved schedule persistence, migration 044, API route foundation, write contract documentation, employee write validation cleanup, and clean full-replacement packaging.

## v4.5.0 — Availability, Preferences, Restrictions + Navigation Exposure
...
## v4.5.0 — Employee Portal Preview + Builder Autocomplete
...
## Signal Schedule v4.5.0 — Beta Foundation & Publishing
...
## v4.5.0 — Schedule Planning & Forecast Horizon
...
## v4.5.0 — Schedule File Organization & Release Cleanup
