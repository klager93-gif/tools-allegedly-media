...
Signal Schedule v0.8.2 adds benefit ledger planning. Benefit balances should be derived from auditable ledger entries rather than overwritten as silent totals.
