# File Manifest — Signal Schedule v5.1.0 Full Replacement
...
- `schedule/EMPLOYEE-PORTAL-NAVIGATION-HOTFIX.md`
...
- `schedule/PUBLISHING-FOUNDATION.md`
- `schedule/README.md`
- `schedule/REQUEST-APPROVAL-ENGINE.md`
...
- `schedule/api/contracts/request-approval-engine.read.schema.json`
...
- `schedule/api/coolify/sql/046_request_approval_engine_schema.sql`
...
- `schedule/data/request-approval-engine-preview.json`
...
- `schedule/pages/requests/request-engine.css`
- `schedule/pages/requests/request-engine.js`
