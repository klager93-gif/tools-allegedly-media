# Signal Schedule File Manifest — v3.5.0

Generated for Signal Schedule v3.5.0 — Dense Tables & Workspace.

## Scope

Full replacement package. Schedule files were retained unless obsolete packaging junk or deprecated generated artifacts were excluded.
...
- `schedule/*.html` version/cache references
- Schedule changelogs, roadmap, README, and release metadata
