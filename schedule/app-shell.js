...
(function () {
  ...
  function rebuildNavigation() {
    ...
    const groups = [
      ...
      { label: 'Calendar', href: 'workspace.html', icon: '▣', children: ['workspace.html', 'planning.html', 'draft-planning.html', 'weekly-board.html', 'daily-board.html', 'schedule.html'] },
      ...
      { label: 'Assignments', href: 'assignments.html', icon: '▦', children: ['assignments.html', 'assignment-generator.html', 'planning.html', 'draft-planning.html', 'conflict-detection.html'] },
