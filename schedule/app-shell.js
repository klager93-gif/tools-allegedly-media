...
(function () {
  ...
  function rebuildNavigation() {
    ...
    const groups = [
      ...
      { label: 'Calendar', href: 'builder.html', icon: '▣', children: ['builder.html', 'workspace.html', 'planning.html', 'draft-planning.html', 'history.html', 'publishing.html', 'weekly-board.html', 'daily-board.html', 'schedule.html'] },
      { label: 'Me / Employees', href: 'employee/index.html', icon: '👥', children: ['employee/index.html', 'employee/calendar.html', 'employee/requests.html', 'employee/profile.html', 'employees.html', 'availability.html', 'profile.html', 'timeline.html', 'supervisors.html', 'seniority.html', 'qualifications.html', 'training.html', 'eligibility.html'] },
      ...
      { label: 'Requests', href: 'requests.html', icon: '✎', children: ['requests.html', 'approvals.html', 'leave.html', 'leave-banks.html', 'open-shifts.html', 'ot-volunteer-board.html', 'shift-trades.html'] },
      ...
      { label: 'Settings', href: 'settings.html', icon: '⚙', children: ['settings.html', 'data-tools.html', 'visibility.html'] }
    ];
  ...
  function getSchedulePath() {
    const parts = location.pathname.split('/schedule/');
    return (parts[1] || location.pathname.split('/').pop() || 'index.html').replace(/^\/+/, '') || 'index.html';
  }
