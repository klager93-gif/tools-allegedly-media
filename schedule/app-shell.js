...
(function () {
  ...
  function rebuildNavigation() {
    ...
    const groups = [
      ...
      { label: 'Calendar', href: 'workspace.html', icon: '▣', children: ['workspace.html', 'planning.html', 'draft-planning.html', 'publishing.html', 'weekly-board.html', 'daily-board.html', 'schedule.html'] },
