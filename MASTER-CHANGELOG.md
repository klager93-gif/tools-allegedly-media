...
- Began Paycheck migration into the Signal Labs design system.
- Added shared-style navigation, active Paycheck nav state, action-bar refinement, modal styling, and toast feedback support.
- No calculator math changes.
